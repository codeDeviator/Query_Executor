...
// //       const userQueries = savedQueries.filter((query: { requesterId: string; }) => query.requesterId === `R00${user.userId}`);

// //       setFiles(
// //         userQueries.map((query: { queryId: any; status: any; }, index: number) => ({
...
//       // Filter queries that match the logged-in requester's userId
//       const userQueries = savedQueries.filter(
//         (query: { requesterId: string; }) => query.requesterId === `R00${user.userId}`
//       );
...
//           name: `query_${query.queryId || index + 1}.txt`,
//           status: query.status || "Pending",
//           createdAt: new Date().toLocaleString(), // Adds local time to createdAt
//         }))
//       );
//     };
...
//                     {file.status}
//                   </td>
//                   <td className="p-3 text-gray-600">{file.createdAt}</td>
//                 </tr>
//               ))}
//             </tbody>
//           </table>
